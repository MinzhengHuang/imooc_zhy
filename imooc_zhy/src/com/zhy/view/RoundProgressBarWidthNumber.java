...
public class RoundProgressBarWidthNumber extends HorizontalProgressBarWithNumber {
    ...
    public RoundProgressBarWidthNumber(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RoundPBWidthNumber);
        mRadius = (int) ta.getDimension(R.styleable.RoundPBWidthNumber_radius, mRadius);
        ta.recycle();
