...
import com.imooc_weixin_recorder.view.AudioRecorderButton;
import com.imooc_weixin_recorder.view.AudioRecorderButton.AudioFinishRecorderListener;
...
public class WeixinRecorderActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mbtnAudioRecorder.setAudioFinishRecorderListener(new AudioFinishRecorderListener() {
